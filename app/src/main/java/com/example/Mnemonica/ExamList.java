...
public class ExamList extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        valueList = (ListView) findViewById(R.id.examList);
  ...
  /*     for (int j=0; j<sss.size(); j=j+6){
        ...
        valueList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AlertDialog.Builder adb=new AlertDialog.Builder(ExamList.this);
                adb.setTitle("Delete?");
                ...
                adb.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dataRef.child(userID).child("Exams").child(b).removeValue();
